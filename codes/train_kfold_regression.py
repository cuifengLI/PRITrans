...
filename = 'F:\\protein_stability\\result\\S394\\deeplearn_10fold_181.xlsx'
...
def cross_validation(train_esm, train_prot, train_label, valid_esm, valid_prot, valid_label, test_esm, test_prot,
    ...
    plt.xlabel('120 Epochs 30 patience')
    plt.ylabel('RMSE')
    plt.legend()
    plt.show()
    ...
    result_end = fr'F:\\protein_stability\\result\\S394\\deeplearn_181_label_{i}_{k}.csv'
...
if __name__ == "__main__":
    ...
    print("交叉验证样本数量:", len(all_label_train))
