...
if __name__ == "__main__":
    ...
    for i in range(1, 21):
        train_ESM, test_ESM, train_Prot, test_Prot, train_Y, test_Y = train_test_split(all_esm_train, all_prot_train,
                                                                                       all_label_train, test_size=0.2,
                                                                                       random_state=42)
